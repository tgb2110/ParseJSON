...
@interface JSONTableViewController2 ()

@end

@implementation JSONTableViewController2
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"alsoBasicCell" forIndexPath:indexPath];
